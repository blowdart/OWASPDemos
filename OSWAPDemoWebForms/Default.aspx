...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">This site deliberately demonstrates insecure coding and configuration practices. Nothing here should be taken as best practice.</p>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <h2>XSS</h2>
            <p>
                <a href="xss.aspx" class="btn btn-default" >Bad Example »</a>
            </p>
            <p>
                <a href="fixedxss.aspx" class="btn btn-default" >Good Example »</a>
            </p>
        </div>
    </div>
